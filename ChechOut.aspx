<%@ Page Title="" Language="C#" MasterPageFile="~/Daily Deli Master Page.Master" AutoEventWireup="true"
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="progress">
        <div class="active"><span class="circle"><i class="fas fa-user"></i></span><span class="label">CUSTOMER INFO</span></div>
        <div class="active"><span class="circle"><i class="fas fa-truck"></i></span><span class="label">SHIPPING METHOD</span></div>
        <div><span class="circle"><i class="fas fa-credit-card"></i></span><span class="label">PAYMENT INFO</span></div>
    </div>
    ...
    <div class="checkout-container">
        ...
        <div class="checkout-form">
            ...
            <div class="two-col">
                <div>
                    <asp:Label ID="lblFirstName" runat="server" Text="First Name:" AssociatedControlID="txtFirstName"></asp:Label><br />
                    <asp:TextBox ID="txtFirstName" runat="server" placeholder="First Name" ReadOnly="true"></asp:TextBox>
                </div>
                <div>
                    <asp:Label ID="lblLastName" runat="server" Text="Last Name:" AssociatedControlID="txtLastName"></asp:Label><br />
                    <asp:TextBox ID="txtLastName" runat="server" placeholder="Last Name" ReadOnly="true"></asp:TextBox>
                </div>
            </div>

            <h2>SHIPPING ADDRESS</h2>

            <asp:Label ID="lblPhoneNumber" runat="server" Text="Phone Number:" AssociatedControlID="txtPhoneNumber"></asp:Label><br />
            ...
            <asp:Label ID="lblPostalCode" runat="server" Text="Postal Code:" AssociatedControlID="txtPostalCode"></asp:Label><br />
            <asp:TextBox ID="txtPostalCode" runat="server" placeholder="Postal Code" required></asp:TextBox><br />

            <br />
            <asp:Button ID="btnContinue" runat="server" Text="Continue to Payment" OnClientClick="showPaymentPanel(); return false;" OnClick="btnContinue_Click" />
        </div>
        ...
        <div class="checkout-cart">
            ...
            <div id="dynamic-cart-items">
                <div class="cart-item">
                    ...
                    <div style="flex-grow: 1;">
                        <p style="font-size: 16px; font-weight: bold; margin: 0;">Premium Product <span style="color: #0077cc;">x1</span></p>
                ...
                <div class="cart-item">
                    <img src="https://via.placeholder.com/110x110/f8faff/4a6cf7?text=Product" alt="Product">
                    <div style="flex-grow: 1;">
                        <p style="font-size: 16px; font-weight: bold; margin: 0;">Special Item <span style="color: #0077cc;">x1</span></p>
            ...
            <div class="totals">
                ...
                <p class="grand-total"><span class="total-label">Grand Total</span><span class="total-amount">R279.98</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="payment-panel" id="paymentPanel">
        ...
        <div class="payment-input-container">
            ...
            <input type="text" placeholder="Card Number" maxlength="19" id="cardNumber" oninput="formatCardNumber(this)" />
        </div>

        <div class="payment-input-container">
            <i class="fas fa-user"></i>
            <input type="text" placeholder="Name on Card" id="cardName" oninput="document.getElementById('cardNameDisplay').textContent = this.value || 'YOUR NAME'" />
        </div>

        <div class="payment-row">
            <div class="payment-input-container" style="flex: 1;">
                <i class="fas fa-calendar-alt"></i>
                <input type="text" placeholder="MM/YY" maxlength="5" id="cardExpiry" oninput="formatExpiry(this)" onfocus="flipCard(true)" onblur="flipCard(false)" />
            </div>
            <div class="payment-input-container" style="flex: 1;">
                <i class="fas fa-lock"></i>
                <input type="text" placeholder="CVV" maxlength="3" id="cardCvv" oninput="document.getElementById('cardCvvDisplay').textContent = this.value || '***'" onfocus="flipCard(true)" onblur="flipCard(false)" />
            </div>
        </div>

        <asp:Button ID="btnPayNow" runat="server" Text="Pay Now" OnClick="btnPayNow_Click1" CssClass="pay-now-btn" />
    ...
    <div class="invoice-panel" id="invoicePanel">
        ...
        <button type="button" onclick="downloadInvoice()" class="pay-now-btn"><i class="fas fa-download"></i> Download as PDF</button>
    </div>
