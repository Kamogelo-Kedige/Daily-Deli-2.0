<%@ Page Title="" Language="C#" MasterPageFile="~/Daily Deli Master Page.Master" AutoEventWireup="true" CodeBehind="Add_Products.aspx.cs" Inherits="Daily_Deli_E_Commerce.Add_Products" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .admin-wrap .container {           /* <-- let the container be wider */
  max-width: 1280px;               /* set your desired cap */
  width: 100%;
}

        .admin-wrap .row {                 /* optional: keep content centered */
...
.card {
  ...
  max-width: 800px;               /* <-- your target width */
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <asp:TextBox ID="Imageurl" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="3"></asp:TextBox>
                        ...
                        <div class="mt-4">
                            <asp:Button ID="btnSave" runat="server" Text="Save Product" CssClass="site-btn" OnClick="btnSave_Click" />
                        
                            <asp:Button ID="btnAdminPage" runat="server" CssClass="btn btn-edit" Text="Back to home" OnClick="btnAdmin_Page" />
