<%@ Page Title="" Language="C#" MasterPageFile="~/Daily Deli Master Page.Master" AutoEventWireup="true"
    CodeBehind="Admin.aspx.cs" Inherits="Daily_Deli_E_Commerce.Admin" %>


    <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <title>Admin - Daily Deli</title>
        ...
        <style>
            ...
            *::after {
            ...
            .stats-grid {
                ...
                /* keep centered inside a wider container */
            }
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <div class="admin-card text-center">
                        ...
                        <br>
                        <br>
                        <asp:Button ID="Button2" runat="server" Text="View Profile" CssClass="btn btn-lg w-100"
                    ...
                    <div class="cards-grid">
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm text-center p-4"
                                ...
                                <asp:Button ID="Button1" runat="server" Text="Open" CssClass="btn btn-lg w-50"
                                    Style="background: linear-gradient(90deg, #ff9966, #ff5e62); border: none; color: #fff; font-weight: 600; border-radius: 25px;"
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm text-center p-4"
                                ...
                                <asp:Button ID="btnProducts" runat="server" Text="Open" CssClass="btn btn-lg w-50"
                                    Style="background: linear-gradient(90deg, #ff9966, #ff5e62); border: none; color: #fff; font-weight: 600; border-radius: 25px;"
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm text-center p-4"
                                ...
                                <!-- ASP Button -->
                                <asp:Button ID="btnOrders" runat="server" Text="Open" CssClass="btn btn-lg w-50"
                                    Style="background: linear-gradient(90deg, #ff9966, #ff5e62); border: none; color: #fff; font-weight: 600; border-radius: 25px;" />
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm text-center p-4"
                                ...
                                <!-- ASP Button -->
                                <asp:Button ID="btnUsers" runat="server" Text="Open" CssClass="btn btn-lg w-50"
                                    Style="background: linear-gradient(90deg, #ff9966, #ff5e62); border: none; color: #fff; font-weight: 600; border-radius: 25px;"
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm text-center p-4"
                                ...
                                <asp:Button ID="btnRecipes" runat="server" Text="Open" CssClass="btn btn-lg w-50"
                                    Style="background: linear-gradient(90deg, #ff9966, #ff5e62); border: none; color: #fff; font-weight: 600; border-radius: 25px;" />
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm text-center p-4"
                                ...
                                <asp:Button ID="btnDiscounts" runat="server" Text="Open" CssClass="btn btn-lg w-50"
                                    Style="background: linear-gradient(90deg, #ff9966, #ff5e62); border: none; color: #fff; font-weight: 600; border-radius: 25px;" />
