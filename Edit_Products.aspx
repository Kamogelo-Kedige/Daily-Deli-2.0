<%@ Page Title="" Language="C#" MasterPageFile="~/Daily Deli Master Page.Master" AutoEventWireup="true"
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        ...
        <title>Edit Products - Daily Deli</title>
    ...
    WHERE ISNULL(@q,'') = ''
       ...
       OR (name LIKE '%' + @q + '%')">
                                <selectparameters>
                                    <asp:ControlParameter ControlID="txtSearch" Name="q" PropertyName="Text"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-2 mb-2">
                                <div class="col-6">
                                    ...
                                    <asp:TextBox ID="pprice" runat="server" ClientIDMode="Static"
                                        CssClass="form-control" TextMode="Number" step="0.01" min="0" />
                                ...
                                <div class="col-6">
                                    ...
                                    <asp:TextBox ID="pstock" runat="server" ClientIDMode="Static"
                                        CssClass="form-control" TextMode="Number" step="1" min="0" />
                            ...
                            <div class="d-flex gap-2 mb-3">
                                <asp:Button ID="btnSave" runat="server" ClientIDMode="Static" CssClass="btn btn-success"
                                    Text="Save" OnClientClick="return false;" />
                                <asp:Button ID="btnReset" runat="server" ClientIDMode="Static"
                                    CssClass="btn btn-outline-secondary" Text="Reset" OnClientClick="return false;" />
                            </div>
